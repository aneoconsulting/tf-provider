...
impl tf::provider_server::Provider for CmdProvider {
    async fn get_provider_schema(
        ...
        tonic::Response<tf::get_provider_schema::Response>,
        tonic::Status,
    > {
        unimplemented!();
    }
    async fn validate_provider_config(
        ...
        tonic::Response<tf::validate_provider_config::Response>,
        tonic::Status,
    > {
        unimplemented!();
    }
    async fn validate_resource_config(
        ...
        tonic::Response<tf::validate_resource_config::Response>,
        tonic::Status,
    > {
        unimplemented!();
    }
    async fn validate_data_resource_config(
        ...
        tonic::Response<tf::validate_data_resource_config::Response>,
        tonic::Status,
    > {
        unimplemented!();
    }
    async fn upgrade_resource_state(
        ...
        tonic::Response<tf::upgrade_resource_state::Response>,
        tonic::Status,
    > {
        unimplemented!();
    }
    ...
    async fn plan_resource_change(
        ...
        tonic::Response<tf::plan_resource_change::Response>,
        tonic::Status,
    > {
        unimplemented!();
    }
    async fn apply_resource_change(
        ...
        tonic::Response<tf::apply_resource_change::Response>,
        tonic::Status,
    > {
        unimplemented!();
    }
    async fn import_resource_state(
        ...
        tonic::Response<tf::import_resource_state::Response>,
        tonic::Status,
    > {
        unimplemented!();
    }
